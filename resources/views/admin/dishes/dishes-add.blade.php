      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="col-lg-10">
              <div class="box-body">
                <form enctype="multipart/form-data" role="form" class="" method="post" action="<?= (!isset($data)) ? action('admin\DishesController@store') : action('admin\DishesController@update', ['id' => $data->id]); ?>">
                  @csrf
